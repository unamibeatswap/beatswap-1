...
const getSelectedSlice = (snapshot) => selector_isSelectionExpanded.getSelectedValue(snapshot), getSelection = (snapshot) => snapshot.context.selection, getValue = (snapshot) => snapshot.context.value;
